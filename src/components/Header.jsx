            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0  d-flex justify-content-center align-items-center gap-3">
                            <li class="nav-item">
                    ...
                    <div class="mask" style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)' }}>
                        <div class="d-flex justify-content-center align-items-center h-100">
                            <div class="text-white">
                                <h1 class="mb-3">Welcome to Banki</h1>
                                <h4 class="mb-3">Check customers data</h4>
                                <a class="btn btn-outline-light btn-lg" href="#table" role="button"
                                >show now</a>
                            </div>
                        </div>
                    </div>
